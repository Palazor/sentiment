...
f = open('/media/razor/Files/projects/Review-Helpfulness-Prediction/main/Preprocessing module/pos_review.txt')
pos_review = json.loads(f.readline(), 'utf-8')
f.close()
f = open('/media/razor/Files/projects/Review-Helpfulness-Prediction/main/Preprocessing module/neg_review.txt')
neg_review = json.loads(f.readline(), 'utf-8')
f.close()
...
def create_word_bigram_scores():
    ...
    # negdata = tp.seg_fil_senti_excel("D:/code/sentiment_test/neg_review.xlsx", 1, 1)
    f = open('/media/razor/Files/projects/Review-Helpfulness-Prediction/main/Preprocessing module/pos_review.txt')
    posdata = json.loads(f.readline(), 'utf-8')
    f.close()
    f = open('/media/razor/Files/projects/Review-Helpfulness-Prediction/main/Preprocessing module/neg_review.txt')
    negdata = json.loads(f.readline(), 'utf-8')
    f.close()
