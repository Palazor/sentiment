...
import jieba
import jieba.posseg
jieba.load_userdict('/media/razor/Files/projects/Review-Helpfulness-Prediction/main/Preprocessing module/userdict.txt') #Load user dictionary to increse segmentation accuracy
...
def seg_fil_senti_excel(filepath, sheetnum, colnum):
    ...
    sentiment_stopwords = get_txt_data('/media/razor/Files/projects/Review-Helpfulness-Prediction/main/Preprocessing module/sentiment_stopword.txt', 'lines')
...
import json
pos_review = seg_fil_senti_excel("/media/razor/Files/projects/Review-Helpfulness-Prediction/main/Feature extraction module/Sentiment features/Machine learning features/seniment review set/pos_review.xlsx", 1, 1)
f = open('pos_review.txt', 'w+')
f.write(json.dumps(pos_review, ensure_ascii=False).encode('utf-8'))
f.close()
neg_review = seg_fil_senti_excel("/media/razor/Files/projects/Review-Helpfulness-Prediction/main/Feature extraction module/Sentiment features/Machine learning features/seniment review set/neg_review.xlsx", 1, 1)
f = open('neg_review.txt', 'w+')
f.write(json.dumps(pos_review, ensure_ascii=False).encode('utf-8'))
f.close()